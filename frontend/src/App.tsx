...
function App() {
  const [activeTab, setActiveTab] = useState<'userStory' | 'testCaseGen'>('userStory');
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: 32, marginBottom: 32, gap: 24 }}>
        <button
          onClick={() => setActiveTab('userStory')}
          style={{
            background: activeTab === 'userStory' ? '#3498db' : '#f8f9fa',
            color: activeTab === 'userStory' ? '#fff' : '#2c3e50',
            border: 'none',
            borderRadius: 6,
            padding: '12px 32px',
            fontWeight: 600,
            fontSize: 18,
            cursor: 'pointer',
            boxShadow: activeTab === 'userStory' ? '0 2px 8px rgba(52,152,219,0.08)' : 'none',
            transition: 'background 0.2s, color 0.2s',
          }}
        >
          User Story to Testcases
        </button>
        <button
          onClick={() => setActiveTab('testCaseGen')}
          style={{
            background: activeTab === 'testCaseGen' ? '#3498db' : '#f8f9fa',
            color: activeTab === 'testCaseGen' ? '#fff' : '#2c3e50',
            border: 'none',
            borderRadius: 6,
            padding: '12px 32px',
            fontWeight: 600,
            fontSize: 18,
            cursor: 'pointer',
            boxShadow: activeTab === 'testCaseGen' ? '0 2px 8px rgba(52,152,219,0.08)' : 'none',
            transition: 'background 0.2s, color 0.2s',
          }}
        >
          Test Case Generator
